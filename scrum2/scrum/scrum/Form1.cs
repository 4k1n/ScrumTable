...
namespace scrum
{
    public partial class frmScrum : Form
    {
        ...
        private void btnTaskEkle_Click(object sender, EventArgs e)
        {
            ...
            yeniButon.MouseClick += YeniButon_MouseClick;
        ...
        private void YeniButon_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            MessageBox.Show("Story Adı:" + Environment.NewLine+ task[indis].storyAdi + Environment.NewLine + "Task Adı:" + Environment.NewLine + task[indis].taskAdi + Environment.NewLine + "Task Yazarı:" + Environment.NewLine + task[indis].taskYazari + Environment.NewLine + "Task Açıklaması:" + task[indis].taskAciklamasi);
        }
        ...
        private void txtTaskAciklama_TextChanged(object sender, EventArgs e)
        {
        ...
        private void txtStoryYazari_TextChanged(object sender, EventArgs e)
        {

        }

        private void txtStoryName_TextChanged(object sender, EventArgs e)
        {

        }

        private void lblStoryName_Click(object sender, EventArgs e)
        {

        }

        private void lblStoryYazari_Click(object sender, EventArgs e)
        {

        }

        private void lblStoryAciklama_Click(object sender, EventArgs e)
        {
